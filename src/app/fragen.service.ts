...
import { McFrage ,McAntwort} from './mc-frage';
import { ScFrage } from './sc-frage';
// import { MultiEinzelfrageComponent } from './multi-einzelfrage/multi-einzelfrage.component';
import { FillinFrage } from './fillin-frage';
// import { MultiFragenlisteComponent } from './multi-fragenliste/multi-fragenliste.component';

// import MultipleChoiceJson
  ...
  constructor()
  {
    ...
    [
      ...
      },
      {
        ...
        antworten:[
          {text:`A.  cat <!EOT',"test 'EOT'`, correct: false},
